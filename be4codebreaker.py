...
antipycdc = "try:minopy=(" + antipycdc + ")\nexcept:pass"
...
class OBF_STRING:
    def __init__(self, SECURITE, STRING, content: str, clean = True, obfcontent = True) -> None:
...
def Object():return ProjectError("<< ANTI DEBUG - _minopy@Python.system.dev >>")
...
{self.content}""".strip()
    ...
    def Tochuc(self):
        Anti_hook = f"""
class BE4CODEBREAKERPY(MemoryError):0
try:
    if __Author__ != ("Minopy"):
        raise BE4CODEBREAKERPY('>> Break!! BE4CODEBREAKERPY') from None
    if __In4__ != ("https://github.com/minopy","https://minopy.com"):
        raise BE4CODEBREAKERPY('>> Break!! BE4CODEBREAKERPY') from None
...
class BE4CODEBREAKERPY:
    ...
    def CHECK_AND_BLOCK(FUNC):
        if callable(FUNC) and FUNC.__module__ not in _BE4CODEBREAKERPY_.ALLOWED_MODULES:
            _BE4CODEBREAKERPY_.CHECK_HOOKING.add(FUNC.__module__)
            _BE4CODEBREAKERPY_.be4brc()
    @staticmethod
    def BLOCK_AND_ANTI(FUNC):
        def HI(*args, **kwargs):
            if args and args[0] in _BE4CODEBREAKERPY_.CHECK_HOOKING:
                _BE4CODEBREAKERPY_.be4brc()
    ...
    def check(func, md):
        if callable(func) and func.__module__ != md:
            _BE4CODEBREAKERPY_.CHECK_HOOKING.add(md)
            raise ImportError(f'>> Detect [{{func.__name__}}] call [{{md}}] ! <<') from None
    @staticmethod
    def inpandcheck(md, namefunction):
        module = __import__(md)
        function_check = namefunction if isinstance(namefunction, list) else [namefunction]
        [_BE4CODEBREAKERPY_.check(getattr(module, func, None), md) for func in function_check]
    @staticmethod
    def lfn(valimtx, xyz):
        return callable(valimtx) and xyz and valimtx.__module__ != xyz.__name__
    @staticmethod
    def function_check_out(listfunctionandmodule):
        if any(_BE4CODEBREAKERPY_.lfn(valimtx, xyz) for valimtx, xyz in listfunctionandmodule):
           _BE4CODEBREAKERPY_.be4brc()
    @staticmethod
    ...
    def inpandcheck_type(md, namefunction):
        func = _BE4CODEBREAKERPY_.ctypes(md, namefunction)
        _BE4CODEBREAKERPY_.check(func, md)
    @staticmethod
    def block_use_marshal():
...
def setcheck():
    ...
    [_BE4CODEBREAKERPY_.inpandcheck_type(md, namefunction) for md, namefunction in input_check.items()]

    listfunctionandmodule = [
        (__import__('marshal').loads, marshal)
    ]
    _BE4CODEBREAKERPY_.function_check_out(listfunctionandmodule)
    _BE4CODEBREAKERPY_.block_use_marshal()
setcheck()
_BE4CODEBREAKERPY_.BYPASS_HOOKING()


"""

        if self.SECURITE.upper() == "Y":
        ...
        BE4 = """class BE4CODEBREAKERPY(MemoryError):0"""
    ...
    def OBF_Marshal(self, code):
        return __import__('marshal').dumps(compile(code.encode(), '<_minopy>', 'exec'))
...
def compl(v):
    ...
    b = __import__("marshal").dumps(compile(v,"BE4CODEBREAKERPY","exec"))
    b = __import__("zlib").compress(b)
    b = __import__("base64").b64encode(b)
    return f"""
__Author__ = ("Minopy")
__In4__ = ("https://github.com/minopy","https://minopy.com")
class BE4CODEBREAKERPY(MemoryError):0
__a__, _0xBE4xMATIX = ("Minopy"), [
    ["k","a","b"],["j","i","z"],["h","s","r"],["m","2","l"],
    ["o","d"],["1","3","4","6"],["p","e","c"],["y","u","n","g"],
    ["v","[","t","x"]
]
_0x0 = __import__(_0xBE4xMATIX[3][0]+_0xBE4xMATIX[0][1]+_0xBE4xMATIX[2][2]+_0xBE4xMATIX[2][1]+_0xBE4xMATIX[2][0]+_0xBE4xMATIX[0][1]+_0xBE4xMATIX[3][2])
_0x1 = __import__(_0xBE4xMATIX[1][2]+_0xBE4xMATIX[3][2]+_0xBE4xMATIX[1][1]+_0xBE4xMATIX[0][2])
_0x2 = __import__(_0xBE4xMATIX[0][2]+_0xBE4xMATIX[0][1]+_0xBE4xMATIX[2][1]+_0xBE4xMATIX[6][1]+_0xBE4xMATIX[5][3]+_0xBE4xMATIX[5][2])
_0x3 = __import__(_0xBE4xMATIX[0][2]+_0xBE4xMATIX[7][1]+_0xBE4xMATIX[1][1]+_0xBE4xMATIX[3][2]+_0xBE4xMATIX[8][2]+_0xBE4xMATIX[1][1]+_0xBE4xMATIX[7][2]+_0xBE4xMATIX[2][1])
_0x4 = vars().copy()
for BE4, MATIX in vars(_0x0).items():
    if callable(MATIX):
        if BE4 == _0xBE4xMATIX[3][2]+_0xBE4xMATIX[4][0]+_0xBE4xMATIX[0][1]+_0xBE4xMATIX[4][1]+_0xBE4xMATIX[2][1]: _0x4["VE"] = MATIX
        else: _0x4[BE4] = MATIX
for BE4, MATIX in vars(_0x1).items():
    if callable(MATIX):
        if BE4 == _0xBE4xMATIX[4][1]+_0xBE4xMATIX[6][1]+_0xBE4xMATIX[6][2]+_0xBE4xMATIX[4][0]+_0xBE4xMATIX[3][0]+_0xBE4xMATIX[6][0]+_0xBE4xMATIX[2][2]+_0xBE4xMATIX[6][1]+_0xBE4xMATIX[2][1]+_0xBE4xMATIX[2][1]: _0x4["LI"] = MATIX
        else: _0x4[BE4] = MATIX
for BE4, MATIX in vars(_0x2).items():
    if callable(MATIX):
        if BE4 == _0xBE4xMATIX[0][2]+_0xBE4xMATIX[5][3]+_0xBE4xMATIX[5][2]+_0xBE4xMATIX[4][1]+_0xBE4xMATIX[6][1]+_0xBE4xMATIX[6][2]+_0xBE4xMATIX[4][0]+_0xBE4xMATIX[4][1]+_0xBE4xMATIX[6][1]: _0x4["MATIX"] = MATIX
        else: _0x4[BE4] = MATIX
for BE4, MATIX in vars(_0x3).items():
    if callable(MATIX):
        if BE4 == _0xBE4xMATIX[6][1]+_0xBE4xMATIX[8][3]+_0xBE4xMATIX[6][1]+_0xBE4xMATIX[6][2]: _0x4["_BE4CODEBREAKERPY"] = MATIX
        else: _0x4[BE4] = MATIX
globals().update(_0x4)
try:_BE4CODEBREAKERPY(VE(LI(MATIX({b}))))
...
def main():
    try:
        ...
        file = input(stage(f"File {dark}-> {Col.reset}", "BE4CODEBREAKERPY", col2 = bpurple)).replace('"','').replace("'","")
        ...
        #STRING = input("--> String <--\n[X] V1 | [Y] V2: ")
        STRING = input(stage(f"String : [X] V1 | [Y] V2: ", "BE4CODEBREAKERPY", col2 = bpurple)).replace('"','').replace("'","")
        SECURITE = input(stage(f"Exception Protect? : [X] NO | [Y] YES: ", "BE4CODEBREAKERPY", col2 = bpurple)).replace('"','').replace("'","")
        ...
        try:
            ...
            LAYER = OBF_STRING(content=LAYER,STRING=STRING,SECURITE=SECURITE).content

            check_syntax(LAYER)
            MARSHAL = input(stage(f"Wall Compile (If U Dont Compile And Want Raw Code u just del Anti_hook ) : [X] NO | [Y] YES: ", "BE4CODEBREAKERPY", col2 = bpurple)).replace('"','').replace("'","")
        ...
        outx = "Be4-output-"+file
        open(outx, 'w', encoding='utf-8').write(str(LAYER))
        print(stage(f"File Save in {light}{outx}{bpurple}", "BE4CODEBREAKERPY", col2 = bpurple))
        getpass(stage(f"Obfuscation completed succesfully in {light}{now}s{bpurple}.{Col.reset}", "BE4CODEBREAKERPY", col2 = bpurple))
